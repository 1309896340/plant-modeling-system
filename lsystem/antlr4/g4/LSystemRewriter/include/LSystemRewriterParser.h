...
class  LSystemRewriterParser : public antlr4::Parser {
public:
  enum {
  ...
  explicit LSystemRewriterParser(antlr4::TokenStream *input);

  LSystemRewriterParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~LSystemRewriterParser() override;
