...
string Scene::GeometryObject::getName() const { return this->name; }
BvhTree *Scene::GeometryObject::getBvhTree() { return this->bvhtree.get(); }
BoundingBox *Scene::GeometryObject::getBoundingBox() { return this->box.get(); }
Geometry *Scene::GeometryObject::getGeometry() { return this->geometry.get(); }
...
Scene::Scene::findGeometryObjectByName(const string &name) {
  auto iter = find_if(this->objs.begin(), this->objs.end(),
                      [&](pair<const shared_ptr<GeometryObject>,
...
void Scene::Scene::addSceneObject(const shared_ptr<GeometryObject> &obj,
                                  bool visible, bool listed, bool collided,
                                  bool lighted, GLuint texture) {
